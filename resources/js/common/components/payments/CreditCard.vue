<template>
    ...
    Thx random guy from internet. Sorry i forgot your name.

    -->
    <form class="cc-form form">
        <div class="cc-form__cc">
            <div class="creditcard" :class="{flipped: flipped}" @click="flipped = !flipped">
                <div class="front">
                    ...
                    <g id="Front">
                        ...
                        <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" class="st2 st5 st6">{{ displayHolder.toUpperCase() }}</text>
                        <text transform="matrix(1 0 0 1 54.1074 389.8793)" class="st7 st5 st8">cardholder name</text>
                        <text transform="matrix(1 0 0 1 479.7754 388.8793)" class="st7 st5 st8">expiration</text>
                        <text transform="matrix(1 0 0 1 65.1054 241.5)" class="st7 st5 st8">card number</text>
                        <g>
                            <text transform="matrix(1 0 0 1 574.4219 433.8095)" id="svgexpire" class="st2 st5 st9">{{ displayExpirationDate }}</text>
                ...
                <div class="back">
                    ...
                    C707.1,246.4,704.4,249.1,701.1,249.1z" />
                            ...
                            <text transform="matrix(1 0 0 1 621.999 227.2734)" id="svgsecurity" class="st6 st7">{{ displayCvv }}</text>
                            <g class="st8">
                            <text transform="matrix(1 0 0 1 518.083 280.0879)" class="st9 st6 st10">security code</text>
                        </g>
                            <rect x="58.1" y="378.6" class="st11" width="375.5" height="13.5" />
                            <rect x="58.1" y="405.6" class="st11" width="421.7" height="13.5" />
                            <text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" class="st12 st13">{{ displayHolder }}</text>
                    </g>
                </svg>
                </div>
            </div>
...
<script lang="ts">
    ...
    export default class CreditCard extends Vue {
        ...
        cardNumber: string = DEFAULT_CARD;
        valid: boolean = false;
        ...
        get displayExpirationDate() {
            return (this.expiryMonth || '##') + '/' + (this.expiryYear || '##')
        }

        get displayHolder() {
            return this.holder || DEFAULT_HOLDER;
        }
        ...
        onCardChanged(e) {
            ...
            this.cardNumber = value || DEFAULT_CARD;
            this.validateAndEmit()
        }

        onExpirationDateChanged(e) {
            let v = e.target.value;

            let parts = v.split('/');
            this.expiryMonth = !isNaN(+parts[0]) ? parts[0] : null;
            this.expiryYear = !isNaN(+parts[1]) ? parts[1] : null;
            this.validateAndEmit()
        }
        ...
        validateAndEmit() {
            if (this.cvv && /\d{3}/.test(this.cvv) &&
                this.expiryYear && this.expiryMonth &&
                this.holder && /\d{14,19}/.test(this.cardNumber)
            ) {
...
<style scoped lang="scss">
    ...
    // CC styles
    @import "https://cdn.jsdelivr.net/npm/@openfonts/rock-salt_latin@1.44.1/index.min.css";
